...
function addoption()
{
  ...
  Addhtml= '<tr> <td>'+Addselect.options[Addselect.selectedIndex].text+'</td>'
    +'<td> <input class="form-control" type = "number" name=priority'+selectedVal+' style="width:30%" min=1 max=9999> </td> </tr>'
...
function onselection()
{
    ...
    +'<label> Priority: </label> <input class="form-control" type="number" min=1 max=9999 name=priority'+Editselect.options[Editselect.selectedIndex].value+' style="width:15%"> <br>';
